...
var (
	walletCommand = cli.Command{
		...
		Description: `
    arthera wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	arthera wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    arthera account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    arthera account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    arthera account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    arthera account import [options] <keyfile>
