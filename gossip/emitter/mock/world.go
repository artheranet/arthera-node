...
// Source: github.com/artheranet/arthera-node/gossip/emitter (interfaces: External,TxPool,TxSigner,Signer)
...
import (
	...
	iblockproc "github.com/artheranet/arthera-node/internal/inter/iblockproc"
	...
	params "github.com/artheranet/arthera-node/params"
	hash "github.com/artheranet/lachesis/hash"
	idx "github.com/artheranet/lachesis/inter/idx"
...
func (m *MockExternal) GetRules() params.ProtocolRules {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRules")
	ret0, _ := ret[0].(params.ProtocolRules)
	return ret0
}
